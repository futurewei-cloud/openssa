...
class OodaReasoner(BaseReasoner):
    ...
    def reason(self, task: Task, *,
        ...
        """
        logger.info("I am reasoning. I will finish observation, orientation, decision, and act to change the task status.")
    ...
    def _orient(self, task: Task, observations: set[Observation],
        ...
        logger.info("I am orienting by sending the observations into the LLM and get the orientation response with the header.")
    ...
    def _decide(self, orientation: Orientation) -> Decision:
        ...
        logger.info(f"I am deciding. RC= {orientation.startswith(CONFIDENT_HEADER)}")
    ...
    def _act(self, task: Task, orientation: Orientation, decision: Decision):
        ...
        logger.info(f"I am acting. task.status={task.status}, task.result={task.result}")
